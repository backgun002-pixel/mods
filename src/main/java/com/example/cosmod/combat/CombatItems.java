...
public class CombatItems {
    ...
    public static Item ENHANCE_STONE_BASIC;
    public static Item ENHANCE_STONE_MID;
    public static Item ENHANCE_STONE_HIGH;
    public static GemItem GEM_BASIC;
    public static GemItem GEM_MID;
    public static GemItem GEM_HIGH;
    ...
    public static void register() {
        ...
        ENHANCE_STONE_BASIC = plain("enhance_stone_basic");
        ENHANCE_STONE_MID   = plain("enhance_stone_mid");
        ENHANCE_STONE_HIGH  = plain("enhance_stone_high");
        ENHANCE_STONE = ENHANCE_STONE_BASIC; // 하위호환

        GEM_BASIC = register("gem_basic", new GemItem(new Item.Properties().stacksTo(16).setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(CosmodMod.MOD_ID, "gem_basic"))), GemTier.BASIC));
        GEM_MID   = register("gem_mid",   new GemItem(new Item.Properties().stacksTo(16).setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(CosmodMod.MOD_ID, "gem_mid"))),   GemTier.MID));
        GEM_HIGH  = register("gem_high",  new GemItem(new Item.Properties().stacksTo(16).setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(CosmodMod.MOD_ID, "gem_high"))),  GemTier.HIGH));

        ResourceKey<net.minecraft.world.level.block.Block> tableBlockKey =
            ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(CosmodMod.MOD_ID, "enhance_table"));
        ResourceKey<Item> tableItemKey =
            ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(CosmodMod.MOD_ID, "enhance_table"));
        ...
        Registry.register(BuiltInRegistries.ITEM, tableItemKey, new BlockItem(ENHANCE_TABLE, new Item.Properties().setId(tableItemKey)));
    ...
    private static GearItem gear(String id, GearItem.GearType type, SetBonus set) {
        ResourceKey<Item> key = ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(CosmodMod.MOD_ID, id));
        ...
        Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(CosmodMod.MOD_ID, id), item);
        return item;
    }
    ...
    private static GemItem register(String id, GemItem item) {
        Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(CosmodMod.MOD_ID, id), item);
        return item;
    }
}
