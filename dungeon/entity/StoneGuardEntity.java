...
public class StoneGuardEntity extends Monster {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Monster.createMonsterAttributes()
            .add(Attributes.MAX_HEALTH,40.0).add(Attributes.ATTACK_DAMAGE,6.0)
            .add(Attributes.ARMOR,6.0).add(Attributes.MOVEMENT_SPEED,0.18)
            .add(Attributes.KNOCKBACK_RESISTANCE,0.5).add(Attributes.FOLLOW_RANGE,24.0);
    }
    ...
    public void tick() {
        ...
        if(this.getLastHurtByMob() instanceof Player player && this.tickCount%10==0 && this.distanceTo(player)<3.0 && this.random.nextFloat()<0.15f)
    ...
    public void die(DamageSource source) {
        ...
        super.die(source);
        this.level().playSound(null,this.blockPosition(),SoundEvents.STONE_BREAK,this.getSoundSource(),1.0f,0.8f);
    }
