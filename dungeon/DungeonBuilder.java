...
public class DungeonBuilder {
    ...
    private void buildGrandPillar(int x,int y,int z,int h) {
        for (int dy=0;dy<=h;dy++) { BlockState s=(dy==0||dy==h)?DungeonBlocks.WALL_CHISELED:(dy%3==0)?DungeonBlocks.ACCENT_POLY:DungeonBlocks.PILLAR; set(x,y+dy,z,s); set(x+1,y+dy,z,DungeonBlocks.PILLAR); set(x,y+dy,z+1,DungeonBlocks.PILLAR); set(x+1,y+dy,z+1,DungeonBlocks.PILLAR); }
    }

    private void buildBossPillar(int x,int y,int z,int h) {
        for (int dy=0;dy<=h;dy++) { BlockState s=(dy%3==0)?DungeonBlocks.BOSS_ACCENT:DungeonBlocks.BOSS_PILLAR; set(x,y+dy,z,s); }
        set(x,y+1,z,DungeonBlocks.BOSS_ACCENT); set(x,y+h-1,z,DungeonBlocks.BOSS_ACCENT);
        set(x,y+h-2,z+1,DungeonBlocks.LANTERN);
    }
