...
public class CombatItems {
    ...
    public static void register() {
        ...
        GEM_BASIC = register("gem_basic", new GemItem(new Item.Properties().stacksTo(16), GemTier.BASIC));
        GEM_MID   = register("gem_mid",   new GemItem(new Item.Properties().stacksTo(16), GemTier.MID));
        GEM_HIGH  = register("gem_high",  new GemItem(new Item.Properties().stacksTo(16), GemTier.HIGH));
